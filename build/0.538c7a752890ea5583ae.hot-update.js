...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        $.getJSON('https://ajax.googleapis.com/ajax/services/feed/load?num=100&v=1.0&q=' + encodeURIComponent('https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&q=http://www.huhmagazine.co.uk/blog/rss/feed.php') + '&callback=?', function (x) {
