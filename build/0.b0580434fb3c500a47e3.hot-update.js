...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        $.getJSON('https://ajax.googleapis.com/ajax/services/feed/load?num=100&v=1.0&q=' + encodeURIComponent('') + '&callback=?', function (x) {
	            console.log(x);
	    ...
	    render: function render() {
	        ...
	        _.each(list, function (u) {
	            if (that.state[u]) {
	                squares = _.union(squares, _.map([that.state[u][0]], function (e) {
