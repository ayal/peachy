...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchFromPipe = function fetchFromPipe(tracks) {
	  ...
	  $.each(tracks, function (trki, trk) {
	    ...
	    var req = $.getJSON('https://www.googleapis.com/youtube/v3/search?part=snippet&safeSearch=none&max-results=15&key=AIzaSyBG3EPa5XT41Fzqm12vvU9o3RTvmZHm9dg&type=video&q=' + encodeURIComponent(song) + '&callback=?', function (e) {
	  ...
	  componentWillMount: function componentWillMount(ps) {
	    ...
	    if (ps.name) {
	      gettracksfromitunes(ps.name, function (x) {
	        ...
	        $.when.apply($, fetchFromPipe(x[0])).done(function (r) {
