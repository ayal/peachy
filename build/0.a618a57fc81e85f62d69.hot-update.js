...
/***/ function(module, exports, __webpack_require__) {
	...
	var gettracksfromitunes = function gettracksfromitunes(e, t, n) {
	    $.getJSON("//itunes.apple.com/search?term=" + encodeURIComponent(t + " " + e) + "&limit=25&media=music&entity=musicTrack&callback=?", function (r) {
	        console.log(r);
	        var i = $.map(r.results, function (n) {
	            return !clean(n.collectionName).match(clean(e)) || "" === e.trim() || !clean(n.artistName).match(clean(t)) ? null : {
	                name: n.trackName,
	                artist: n.artistName,
	                album: e,
	...
	gettracksfromitunes('fight', 'nicolas jaar', function () {
