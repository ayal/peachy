...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pic = _react2.default.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        $('<img />').css({ position: 'absolute', left: '-10000px' }).appendTo('body').load(function () {
	            var img = this;
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement('img', { src: src, style: { opacity: this.state.opacity, transition: 'all 1s ease', width: this.state.width, height: this.state.height }, ref: 'img' });
	    }
	});
