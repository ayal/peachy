...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var squares = _.shuffle(_.union(_.map(this.state.pitch, function (e) {
	            ...
	            return null && _react2.default.createElement(Square, { href: e.link, name: e.title, text: e.contentSnippet, more: e, getimgsrc: function getimgsrc(x) {
	                    $($(x.content)[0]).attr('src');
	                } });
	...
	var Square = _react2.default.createClass({
	    ...
	    getImgSrcFromContent: function getImgSrcFromContent() {
	        return this.props.getImgSrcFromContent(this.props.more);
	    },
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
