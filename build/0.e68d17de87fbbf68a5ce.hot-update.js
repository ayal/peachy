	    ...
	    render: function render() {
	        ...
	        _.each(list, function (u) {
	            if (that.state[u]) {
	                ...
	                squares = _.union(squares, [_react2.default.createElement(DummySquare, null), _react2.default.createElement(DummySquare, null)]);
	            }
	        });
