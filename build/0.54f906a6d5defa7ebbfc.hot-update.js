...
/***/ function(module, exports, __webpack_require__) {
	...
	var Square = _react2.default.createClass({
	    ...
	    render: function render() {
	        console.log('rendering', this.state.artwork);
	        return _react2.default.createElement(
	            'div',
	            { className: 'square' },
	...
	var Pic = _react2.default.createClass({
	    ...
	    onload: function onload() {
	        $(this.refs.img).css({ visibility: 'visible' });
	    },
	    render: function render() {
	        ...
	        return _react2.default.createElement('img', { src: this.props.src, style: { display: 'none', visibility: 'hidden' }, onLoad: this.onload, ref: 'img' });
	    }
	});
