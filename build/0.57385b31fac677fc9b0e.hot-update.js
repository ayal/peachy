	...
	var Square = _react2.default.createClass({
					...
					render: function render() {
									return _react2.default.createElement(
													...
													_react2.default.createElement(
																	'a',
																	{ className: 'pinit', onClick: this.clicktweet("http://www.pinterest.com/pin/create/button/?url=" + encodeURIComponent(this.props.href) + "&media=" + encodeURIComponent(this.props.src) + "&description=" + encodeURIComponent(this.props.name)) },
																	_react2.default.createElement('i', null)
													),
													_react2.default.createElement(
																	'a',
