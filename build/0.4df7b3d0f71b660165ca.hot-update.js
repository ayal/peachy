	...
	var Pic = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement('img', { src: 'triangles.png', style: { position: 'absolute', 'z-index': 0 } }),
	            _react2.default.createElement('img', { src: src, style: { opacity: 0, 'z-index': 1 }, onLoad: this.onload, ref: 'img' })
	        );
	    }
	});
