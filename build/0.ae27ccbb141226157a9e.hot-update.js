...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        var toset = {};
	        var picked = listpick();
	        var chosen = ['http://pitchfork.com/rss/reviews/best/tracks/', picked, 'http://www.huhmagazine.co.uk/blog/rss/feed.php', 'http://feeds2.feedburner.com/itsnicethat/SlXC'].concat(_toConsumableArray(picked.slice(1)));
	        ...
	        _.each(chosen, function (u) {
	            $.getJSON('https://ajax.googleapis.com/ajax/services/feed/load?num=100&v=1.0&q=' + encodeURIComponent(u) + '&callback=?', function (x) {
	                var toset = {};
	                var e = feedpic(x.responseData.feed.entries);
	                if (e) {
	                    if (u.match('pitchfork')) {
