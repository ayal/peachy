	...
	var Pic = _react2.default.createClass({
	    ...
	    componentWillMount: function componentWillMount() {
	        ...
	        $('<img />').css({ position: 'absolute', left: '-10000px' }).load(function () {
	            that.setState({ loaded: true, opacity: 1 });
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement('img', { src: src, style: { opacity: this.state.opacity || 0, transition: 'opacity 1s ease' }, ref: 'img' });
	    }
	});
