	...
	var Pic = _react2.default.createClass({
	    ...
	    onload: function onload() {
	        ...
	        if (this.state.loaded) {
	            $(this.refs.img).stop(false, false).animate({ opacity: 1 });
	        } else {
	            $(this.refs.img).stop(false, false).animate({ opacity: 0 }, function () {
	                $(that.refs.img).stop(false, false).animate({ opacity: 1 });
	            });
	        }
	    },
	    render: function render() {
	        ...
	        return _react2.default.createElement('img', { src: src, style: { opacity: 0 }, onLoad: this.onload, ref: 'img' });
	    }
	});
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'a',
	                { href: this.props.href, target: '_blank' },
	                _react2.default.createElement(Pic, { src: this.state.artwork || 'triangles.png' }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'text' },
	                    _react2.default.createElement(
