	...
	var App = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var squares = _.map(this.state.pitch, function (e) {
	            return _react2.default.createElement(PitchSquare, { href: e.link, name: e.title, text: e.contentSnippet });
	        });
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'a',
	                { href: 'http://pizi.meteor.com/' + this.state.artist + '/albums/' + this.state.name + '/tracks/', target: '_blank' },
