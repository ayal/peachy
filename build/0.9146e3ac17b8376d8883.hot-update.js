...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        _.each(list, function (u) {
	            if (that.state[u]) {
	                squares = _.union(squares, _.map(that.state[u], function (e) {
	                    return _react2.default.createElement(Square, { href: e.link, name: e.title, text: e.contentSnippet, more: e, getimgsrc: function getimgsrc(x) {
	                            return $($(x.content)[0]).attr('src') || $($(x.content)[0]).find('img').attr('src');
	                        } });
	                }));
	            }
	        });

	        squares = _.shuffle(squares).slice(0.20);
