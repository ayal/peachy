...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var squares = _.union(_.map(this.state.pitch, function (e) {
	            return _react2.default.createElement(PitchSquare, { href: e.link, name: e.title, text: e.contentSnippet, more: e });
	...
	var Square = _react2.default.createClass({
	    ...
	    nav: function nav(k, v) {},
	    getImgSrcFromSnippet: function getImgSrcFromSnippet() {
	        debugger;
	        return $(this.props.more.contentSnippet).find('img').attr('src');
	    },
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { src: this.getImgSrcFromSnippet() }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'text' },
	                    _react2.default.createElement(
	                    ...
	                    $(this.props.more.contentSnippet).text()
	                )
	            )
	        );
	    }
